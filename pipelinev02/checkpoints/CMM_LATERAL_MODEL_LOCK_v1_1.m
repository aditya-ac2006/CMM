function Result = CMM_LATERAL_MODEL_LOCK_v1_1()
% CMM_LATERAL_MODEL_LOCK_v1_1
% ================================================================
...
% OUTPUT
%   CMM_LATERAL_MODEL_LOCK_v1_1/
%       CMM_LATERAL_MODEL_LOCK_v1_1.mat
%       CMM_LATERAL_MODEL_LOCK_REPORT_v1_1.txt
%       MODEL_PARAMETERS_v1_1.csv
%       SWEEP_CHARACTERIZATION_v1_1.csv
%       CONDITION_CHARACTERIZATION_v1_1.csv
%       LOAD_SENSITIVITY_v1_1.csv
%       PRESSURE_SENSITIVITY_v1_1.csv
%       CAMBER_SENSITIVITY_v1_1.csv
%       REPEATABILITY_v1_1.csv
%       SWEEP_SYMMETRY_v1_1.csv
%       MODEL_FIT_METRICS_v1_1.csv
%       MODEL_CONDITION_METRICS_v1_1.csv
%       MODEL_AUDIT_CHECKS_v1_1.csv
...
fprintf('\n============================================================\n');
fprintf(' CMM LATERAL MODEL LOCK v1.1\n');
...
outputFolder = fullfile(baseRoot,'CMM_LATERAL_MODEL_LOCK_v1_1');
...
[checkName,checkPass,checkDetail]=appendCheck(checkName,checkPass,checkDetail,...
    "CANONICAL_R2_SANITY",canonicalMetrics.R2>=0.90,...
    sprintf('Canonical R2 = %.6f',canonicalMetrics.R2));
[checkName,checkPass,checkDetail]=appendCheck(checkName,checkPass,checkDetail,...
...
writetable(ParameterTable,fullfile(outputFolder,'MODEL_PARAMETERS_v1_1.csv'));
writetable(SweepCharacteristics,fullfile(outputFolder,'SWEEP_CHARACTERIZATION_v1_1.csv'));
writetable(ConditionCharacteristics,fullfile(outputFolder,'CONDITION_CHARACTERIZATION_v1_1.csv'));
writetable(LoadSensitivity,fullfile(outputFolder,'LOAD_SENSITIVITY_v1_1.csv'));
writetable(PressureSensitivity,fullfile(outputFolder,'PRESSURE_SENSITIVITY_v1_1.csv'));
writetable(CamberSensitivity,fullfile(outputFolder,'CAMBER_SENSITIVITY_v1_1.csv'));
writetable(Repeatability,fullfile(outputFolder,'REPEATABILITY_v1_1.csv'));
writetable(SweepSymmetry,fullfile(outputFolder,'SWEEP_SYMMETRY_v1_1.csv'));
writetable(ModelFitMetrics,fullfile(outputFolder,'MODEL_FIT_METRICS_v1_1.csv'));
writetable(ConditionModelMetrics,fullfile(outputFolder,'MODEL_CONDITION_METRICS_v1_1.csv'));

AuditChecks = table(checkName,checkPass,checkDetail,...
    'VariableNames',{'Check','Pass','Detail'});
writetable(AuditChecks,fullfile(outputFolder,'MODEL_AUDIT_CHECKS_v1_1.csv'));
...
save(fullfile(outputFolder,'CMM_LATERAL_MODEL_LOCK_v1_1.mat'),...
    'Lock','-v7.3');

%% ------------------------------------------------------------------------
% REPORT
% -------------------------------------------------------------------------
reportPath = fullfile(outputFolder,'CMM_LATERAL_MODEL_LOCK_REPORT_v1_1.txt');
fid = fopen(reportPath,'w');

if fid ~= -1
    fprintf(fid,'CMM LATERAL MODEL LOCK v1.1\n');
    fprintf(fid,'============================================================\n\n');
...
% -------------------------------------------------------------------------
fprintf('\n============================================================\n');
fprintf(' CMM LATERAL MODEL LOCK v1.1 COMPLETE\n');
fprintf(' STATUS : %s\n',passFail(LockPass));
fprintf(' OUTPUT : %s\n',outputFolder);
fprintf('============================================================\n');
